...
export default {
  ...
  methods: {
    ...
    handleInput(val) {
      this.text = val
      if (this.listenersInput && typeof this.listenersInput.input === 'function') {
        this.listenersInput.input(val)
      }
    },
    handleClear() {
      this.$emit('clear')
      if (this.listenersInput && typeof this.listenersInput.clear === 'function') {
        this.listenersInput.clear()
      }
