<template>
  <div ref="wrapper" :class="{ 'search-wrapper': true, collapse }">
    <y-form v-if="!!columns && !!columns.length" :model="form" class="search-content" @submit.native.prevent>
      <y-form-item
    ...
    <div class="btn-group">
      <y-button type="primary" @click="handleSearch">查 询</y-button>
      <y-button plain @click="handleReset">重 置</y-button>
    </div>
